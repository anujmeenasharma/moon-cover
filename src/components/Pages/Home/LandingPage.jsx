    ...
    <div className="h-screen w-full relative overflow-hidden">
      <div className="absolute z-20 left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 flex justify-center items-center flex-col gap-6">
        ...
        <div className="flex flex-col gap-2 justify-center">
          <p
            ref={textRef}
            className="will-change-transform capitalize text-center"
          >
          ...
          <div className="flex gap-2 justify-center items-center relative ">
            ...
            <div className="relative " ref={textRef1}><ScrambleText textSize="6xl" text="monshoot" />
              </div>
            <div className="relative" ref={textRef2}><ScrambleText textSize="6xl font-normal" text="studio" />
              </div>
          </div>
          <p
            ref={textRef3}
          ...
          >
            ...
            scale into lasting legacies.
          </p>
        </div>
        <h1
          ref={textRef4}
          className="text-center font-light uppercase flex items-center gap-2"
        >
          See how it works
          <img
